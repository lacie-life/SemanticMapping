...
#ifndef SEMATICSLAM_DUALCONIC_H
#define SEMATICSLAM_DUALCONIC_H
...
template <>
struct gtsam::traits<semanticSLAM::DualConic>
        : public gtsam::Testable<semanticSLAM::DualConic> {};
/** \endcond */

#endif //SEMATICSLAM_DUALCONIC_H
