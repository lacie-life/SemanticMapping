...
#ifndef SEMATICSLAM_BOUNDINGBOXFACTOR_H
#define SEMATICSLAM_BOUNDINGBOXFACTOR_H
...
template <>
struct gtsam::traits<semanticSLAM::BoundingBoxFactor>
        : public gtsam::Testable<semanticSLAM::BoundingBoxFactor> {};
/** \endcond */

#endif //SEMATICSLAM_BOUNDINGBOXFACTOR_H
