...
#ifndef SEMANTICSLAM_INITIAL_POSE_FACTOR_H
#define SEMANTICSLAM_INITIAL_POSE_FACTOR_H
...
class initial_pose_factor : public ceres::SizedCostFunction<6, 7>
{
public:
    initial_pose_factor(const Eigen::Vector3d &_P, const Eigen::Quaterniond &_Q)
    {
        init_P = _P;
        init_Q = _Q;
...
#endif //SEMANTICSLAM_INITIAL_POSE_FACTOR_H
