...
#ifndef AG_MAPPING_OBJECTDATABASE_H
#define AG_MAPPING_OBJECTDATABASE_H
...
public:
    ...
    void addObject(AG_MAPPING::Object_Map* object);
    ...
    std::vector<AG_MAPPING::Object_Map*> getObjectMapByName(int objectName);

    // Get all objects
    std::vector<AG_MAPPING::Object_Map*> getAllObject();

    // Semantic point cloud target array
    std::vector<Cluster> mClusters;

    std::vector<AG_MAPPING::Object_Map*> mObjects;
protected:
...
#endif //AG_MAPPING_OBJECTDATABASE_HmpDetector
